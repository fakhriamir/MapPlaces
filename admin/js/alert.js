...
(function ($) {
	...
	$.alerts = {
		...
		okButton: '&nbsp;باشه&nbsp;',         // text for the OK button
		cancelButton: '&nbsp;نه&nbsp;', // text for the Cancel button
		dialogClass: null,                  // if specified, this class will be applied to all dialogs

		// Public methods
		alert: function (message, title, callback) {
			if (title == null) title = 'پیام سیستم';
		...
		customConfirm: function (message, title, okButton, cancelButton, callback) {
			...
			$.alerts._show(title, message, null, 'confirm', function (result) {
				...
				$.alerts.okButton = '&nbsp;باشه&nbsp';
				$.alerts.cancelButton = '&nbsp;نه&nbsp';
			});
		},
